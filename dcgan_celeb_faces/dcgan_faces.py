...
class FaceGenerator:
    ...
    def get_training_data(self,datafolder):
        ...
        for filename in tqdm(filenames[:5000]):
...
if __name__ == '__main__':
    ...
    facegenerator.train(datafolder="../datasets/processed-celeba-small/processed_celeba_small/celeba/",epochs=40, batch_size=32, save_images_interval=10)
